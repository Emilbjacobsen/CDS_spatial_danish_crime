...
#all_crime <- all_crime[-c(1,3), -1]
#rename colums with names of the first row
#colnames(all_crime) <- all_crime[1, ]
# delete row with rownames
#all_crime <- all_crime[-1,]
# drop NA-rows
#all_crime <- all_crime[complete.cases(all_crime), ]
#drop 'ukendt kommune' row
#all_crime <- all_crime[-100,]
...
perform_statistical_test <- function(data, year1, year2, alpha = 0.05) {
  # Extract the crime rate columns for the given years
  values <- data[, c(year1, year2)]
  
  # Perform paired t-test
  t_test <- t.test(values[, 1], values[, 2], paired = TRUE)
...
# Apply the statistical test for each pair of consecutive years
df_stat <- crime_data_final %>%
  mutate(change_2013_2014 = perform_statistical_test(., "change_2013", "change_2014"),
         change_2014_2015 = perform_statistical_test(., "change_2014", "change_2015"),
         change_2015_2016 = perform_statistical_test(., "change_2015", "change_2016"),
         change_2016_2017 = perform_statistical_test(., "change_2016", "change_2017"),
         change_2017_2018 = perform_statistical_test(., "change_2017", "change_2018"),
         change_2018_2019 = perform_statistical_test(., "change_2018", "change_2019"),
         change_2019_2020 = perform_statistical_test(., "change_2019", "change_2020"),
         change_2020_2021 = perform_statistical_test(., "change_2020", "change_2021"),
         change_2021_2022 = perform_statistical_test(., "change_2021", "change_2022"))
